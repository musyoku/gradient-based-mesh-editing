...
def forward_face_index_map_cpu(face_vertices, face_index_map, depth_map,
                               silhouette_image):
    rasterize_cpu.forward_face_index_map(face_vertices, face_index_map,
                                         depth_map, silhouette_image)
